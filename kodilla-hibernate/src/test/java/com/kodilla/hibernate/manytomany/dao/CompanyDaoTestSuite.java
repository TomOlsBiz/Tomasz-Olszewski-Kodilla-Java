...
public class CompanyDaoTestSuite {
    ...
    public void testNamedQueryWithParam(){
        ...
        List<Employee> employeeList = employeeDao.retrieveEmployeeByLastname("Kovalsky");
    ...
    @Test
    public void testNamedNativeQueryWithParam() {
        ...
        List<Company> companyList = companyDao.retrieveCompanyByNameBegin("Dat");
